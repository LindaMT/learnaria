;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype.init = function () {
		...
		$elem
			...
			.on('focusin', {'plugin': plugin}, plugin.stopTimer) // stop auto-rotation when carousel receives keyboard focus
			.on('focusout', {'plugin': plugin}, plugin.startTimer) // start auto-rotation when keyboard focus leaves carousel
